...
const ENTER_SERVICE_CATEGORY_VIEW = 'ENTER_SERVICE_CATEGORY_VIEW';
const LEAVE_SERVICE_CATEGORY_VIEW = 'LEAVE_SERVICE_CATEGORY_VIEW';
...
export default function views(state = initialState, action) {
  ...
  case ENTER_SERVICE_CATEGORY_VIEW:
  ...
  case LEAVE_SERVICE_CATEGORY_VIEW:
...
export function enterServiceCategory(time = moment().format()) {
  return {
    type:         ENTER_SERVICE_CATEGORY_VIEW,
...
export function leaveServiceCategory(time = moment().format()) {
  return {
    type:         LEAVE_SERVICE_CATEGORY_VIEW,
    currentView:  'ServiceCategory',
    enterTime:    null,
    leaveTime:    time
  };
